...
EventRepository extends JpaRepository<Event, Long> {
    ...
    List<Event> findAllByProjectIdAndToggleIdOrderByCreatedAtDesc(Long projectId, Long toggleId);
    List<Event> findAllByProjectIdAndInstanceIdOrderByCreatedAtDesc(Long projectId,Long instanceId);
    List<Event> findAllByInstanceIdAndToggleIdOrderByCreatedAtDesc(Long instanceId,Long toggleid);
