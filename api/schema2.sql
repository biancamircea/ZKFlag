...
--
-- Name: instance_environment_id_seq; Type: SEQUENCE; Schema: public; Owner: bianca
--

ALTER TABLE public.instance_environment ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.instance_environment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY public.instance_environment
    ADD CONSTRAINT instance_environment_pkey PRIMARY KEY (id);
