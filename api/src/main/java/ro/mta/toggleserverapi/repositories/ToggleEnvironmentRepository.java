...
public interface ToggleEnvironmentRepository extends JpaRepository<ToggleEnvironment, Long> {
    ...
    void deleteAllByToggle_ProjectAndEnvironment(Project project, Environment environment);

    List<ToggleEnvironment> findAllByToggle_ProjectAndEnvironmentAndEnabledTrue(Project project, Environment environment);

    List<ToggleEnvironment> findAllByToggle(Toggle toggle);

    Optional<ToggleEnvironment> findByToggleIdAndEnvironmentId(Long toggle_id, Long environment_id);
    Optional<ToggleEnvironment> findByToggleIdAndEnvironmentName(Long toggle_id, String environmentName);
    Optional<ToggleEnvironment> findByToggleAndEnvironment(Toggle toggle, Environment environment);
