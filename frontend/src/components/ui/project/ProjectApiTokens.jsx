...
import {getInstanceApiTokens, getToggleEnvironments} from "../../../api/instanceApi.js";
import LoadingBanner from "../common/LoadingBanner.jsx";
import ProjectApiTokensList from "./ProjectApiTokensList.jsx";
import {getActiveEnvironmentsForInstance, getEnabledEnvFromInstance} from "../../../api/environmentApi.js";
export function loader({params}){
    return defer({
        apiTokens: getInstanceApiTokens(params.instanceId) ,
       //environments: getActiveEnvironmentsForInstance(params.instanceId)
    })
}
